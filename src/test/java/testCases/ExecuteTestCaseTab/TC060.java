...
public class TC060 extends BaseClass {
    ...
    public void Verify_popup_notification_appears_automatically_when_a_Test_Run_is_Updated(
            String releaseName,
            String cycleName,
            String subcycleName,
            String suiteName,
        ...
        logger.info("****** Starting TC060: Verify Test Run update notification ******");
        ...
        try {
            ...
            executeLandingPage.verifyTestRunUpdateNotification(trId);
            logger.info("Test Run update notification verified successfully");
