...
public class TC087 extends BaseClass {
    ...
    public void VerifyCSVFleExportFunctionalityOfTestLogDetails(
            String releaseName,
            String trId
    ) throws InterruptedException
    {
        logger.info("*************** Starting TC087 *****************");
        try {
            login();
            ...
            WaitUtils.waitFor2000Milliseconds();
            testRun.selectCSVFileType();
            WaitUtils.waitFor2000Milliseconds();
            logger.info("click save");
            testRun.clickSaveExportButton();
