...
public class TC053 extends BaseClass {
    ...
    public void Verify_correct_defect_D_opens_from_notification(
            String Summary,
            String status,
            String status1
    ) throws InterruptedException {

        logger.info("****** Starting TC053: Verify defect update notification ******");
        ...
        logger.info("****** Finished TC053: Defect update notification verification ******");
    }
}
