...
public class TC006 extends BaseClass {
    ...
    @Test(dataProvider = "tc006", dataProviderClass = DefectTabTestCaseDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyDropdownsExpandCorrectlyOnClick(String expectedUrlAfterClick,String defectID) throws InterruptedException {
