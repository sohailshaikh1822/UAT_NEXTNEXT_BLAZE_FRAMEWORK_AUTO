...
public class TC096 extends BaseClass {

    @Test(dataProvider = "tc096", dataProviderClass = RequirementDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyNavigationToRequirementDetailsPageOnClickingRequirementCreatedNotification(String rQid, String description, String priority, String status, String type
