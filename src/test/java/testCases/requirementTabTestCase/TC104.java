...
public class TC104 extends BaseClass {

    @Test(dataProvider = "tc104", dataProviderClass = DataProviders.RequirementDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyNavigationToModuleDetailsPageOnClickingSubModuleUpdatedNotification(
            String mdName,
            String setMd,
            String desc
    ) throws InterruptedException
    {
        logger.info("****** Starting the TC0104 *****************");
        try {
            login();
            ...
            notificationsListener.clickUpdatedModuleNotification(mdid);
