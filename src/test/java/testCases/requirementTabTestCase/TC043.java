...
@Test(dataProvider = "tc043", dataProviderClass = RequirementDataProvider.class, retryAnalyzer = RetryAnalyzer.class)

public class TC043 extends BaseClass {

    public void VerifyCloseOperationInTestcaseModal(
            String mainProject,
            String epic,
