...
public class TC049 extends BaseClass {
    @Test(dataProvider = "tc049", dataProviderClass = DataProviders.RequirementDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void Verify_Type_dropdown_options_in_Add_TestCase(
            String moduleName,
            String requirementId,
            String Type
    ) {
        logger.info("************ Starting Test Case: Verify Type dropdown options in Add TestCase *****************");
