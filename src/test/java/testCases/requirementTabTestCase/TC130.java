...
public class TC130 extends BaseClass {

    @Test(dataProvider = "tc130", dataProviderClass = RequirementDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyVersionHistoryShowsUserName (
            String project,
            String epic
        ...
        try {
            ...
            Assert.assertTrue(
                    individualModulePage.isAnyUserPresentInVersionHistory(),
                    "No user name found in version history"
            );
            WaitUtils.waitFor2000Milliseconds();
