...
public class TC113 extends BaseClass {

    @Test(retryAnalyzer = RetryAnalyzer.class)
    public void VerifyDeletionNotificationRemainsDisabledEvenAfterModuleRestoration()
            throws InterruptedException {
        logger.info("****** Starting the TC113 ********");
        try {
            login();
            ...
            notificationsListener.verifyDeletedRequirementNotificationDisabled(mdId);
            logger.info("Deleted Module Notification Disabled");
