...
public class TC082 extends BaseClass {
    @Test(dataProvider = "tc082", dataProviderClass = AuthorTestCaseDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void Verifying_the_notification_message_after_creating_a_new_Test_Case(
            String epicName,
            String featureName,
            String rq_id,
            String TCname,
        ...
        logger.info("****** Starting TC082: Verifying the notification message after creating a new Test Case ******");
        ...
        try {
            ...
            authorTestCasePage.verifyTestCaseCreationNotificationForNewTC();
            logger.info("Test Case creation notification verified successfully");
