...
public class TC045 extends BaseClass {
    ...
    @Test(dataProvider = "tc045", dataProviderClass = SettingTestCaseDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyCreationOfCustomeFieldInsideTestSuitTab(
            String fieldName,
            String fieldtype
    ) throws InterruptedException {

        logger.info("****** Starting the TC045 ******");
        try {
            login();
            ...
            logger.info("Navigated to TestSuit tab");
