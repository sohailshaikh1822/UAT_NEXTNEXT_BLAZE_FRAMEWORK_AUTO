...
public class TC071 extends BaseClass {
    @Test(dataProvider = "tc071", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyTooltipIsShownWhenHoveringOverADisabledNotificationWhenATestCycleIsDeletedFromTestPlanTab(
            String projectName,
            String releaseName,
            String cycleName
    )throws InterruptedException
    {
        logger.info("****** Starting TC59 **********");
        ...
        try {
            ...
            logger.info("deleted suit");

            WaitUtils.waitFor2000Milliseconds();

            individualTestCyclePage.VerifyTooltipForADisabledNotificationWhenATestCycleIsDeletedFromTestPlanTab(testCycleId);
            logger.info("Tooltip");
