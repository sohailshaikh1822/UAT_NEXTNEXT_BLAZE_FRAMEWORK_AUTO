...
public class TC042 extends BaseClass {
    @Test(dataProvider = "tc042", dataProviderClass = TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)

    public void VerifyAToastNotificationIsDisplayedWhenADeletedTestSuitIsRestored(
             String projectName,
             String releaseName,
             String suiteName,
             String objectType
    ) throws InterruptedException {
        logger.info("****** Starting TC042 *****************");
        try {
            login();
