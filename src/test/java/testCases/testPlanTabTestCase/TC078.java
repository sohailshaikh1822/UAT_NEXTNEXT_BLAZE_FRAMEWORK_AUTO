...
public class TC078 extends BaseClass {
    @Test(dataProvider = "tc078", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void Verifying_the_notification_navigation_after_updating_an_existing_Suite_in_the_Test_Plan_module(
            String projectName,
            String releaseName,
            String CycleName,
            String SuiteName
        ...
        logger.info("****** Starting TC78: Verify navigation to Test suit details page on clicking Test suit Updated notification *****************");
        ...
        try {
            ...
            individualTestSuitePage.enterDescription("desd");
            logger.info("Filled description by user in suite:");
            WaitUtils.waitFor3000Milliseconds();
            testPlanPage.clickSaveRelease();
            ...
            WaitUtils.waitFor2000Milliseconds();
            notificationsListener.clickCreatedNotification(suiteId);
