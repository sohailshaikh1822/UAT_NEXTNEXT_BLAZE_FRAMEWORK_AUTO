...
public class TC064 extends BaseClass {
    @Test(dataProvider = "tc064", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyDeletionNotificationRemainsDisabledEvenAfterTestSuitRestoration(
            String projectName,
            String releaseName,
            String cycleName,
            String suitName
    )throws InterruptedException
    {
        ...
        try {
            ...
            WaitUtils.waitFor3000Milliseconds();
            testPlanPage.selectRadioById(testSuitId);
            ...
            WaitUtils.waitFor2000Milliseconds();
            individualTestSuitePage.verifyDeletedTestSuiteNotificationNotClickableAfterRestore(testSuitId);
