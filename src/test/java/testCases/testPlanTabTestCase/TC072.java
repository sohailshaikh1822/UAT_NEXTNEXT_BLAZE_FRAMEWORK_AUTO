...
public class TC072 extends BaseClass {
    @Test(dataProvider = "tc072", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyTooltipIsShownWhenHoveringOverADisabledNotificationWhenAReleaseIsDeletedFromTestPlanTab(
            String projectName,
            String releaseName
    )throws InterruptedException
    {
        logger.info("****** Starting TC72 **********");
        ...
        try {
            ...
            individualReleasePage.verifyDeletedReleaseTooltip(releaseId);
