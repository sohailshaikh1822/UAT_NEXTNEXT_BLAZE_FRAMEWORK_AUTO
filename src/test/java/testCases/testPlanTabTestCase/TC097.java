...
public class TC097 extends BaseClass {
    @Test(dataProvider = "tc097", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyNavigationToTestSuiteHistoryTab(
            String projectName,
            String releaseName,
            String suitName
    )
            throws InterruptedException {
        logger.info("****** Starting TC097 *****************");
