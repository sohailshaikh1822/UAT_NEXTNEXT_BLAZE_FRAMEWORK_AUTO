...
public class TC045 extends BaseClass {
    ...
    @Test(dataProvider = "tc045", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)

    public void verify_Recycle_Bin_count_updates_after_restoring_a_Release(String projectName, String releaseName) throws InterruptedException {
        logger.info("****** Starting TC045 *****************");
