...
public class TC052 extends BaseClass {
    ...
    @Test(dataProvider = "tc052", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyingTheToastNotificationMessageAfterUpdatingANewReleaseInTheTestPlanModule(
            String projectName,
            String releaseName,
            String updateReleaseName
    ) throws InterruptedException
    {
        ...
        try {
            ...
            testPlanPage.enterReleaseName(updateReleaseName);
            WaitUtils.waitFor2000Milliseconds();
