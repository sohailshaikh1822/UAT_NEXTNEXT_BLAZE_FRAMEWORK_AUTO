...
public class TC096 extends BaseClass {
    @Test(dataProvider = "tc096", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyNavigationToTestCycleHistoryTab(
            String projectName,
            String releaseName,
            String suitName
    )
            throws InterruptedException {
        logger.info("****** Starting TC096 *****************");
        ...
        try {
            ...
            logger.info("Clicked on the existing Cycle: " + suitName);
            WaitUtils.waitFor1000Milliseconds();
