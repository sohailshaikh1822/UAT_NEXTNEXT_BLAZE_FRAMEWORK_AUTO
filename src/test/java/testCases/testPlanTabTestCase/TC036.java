...
public class TC036 extends BaseClass {
    ...
    public void verifyDeletedTestCycleRestoreSuccessFully(String projectName, String releaseName,  String testCycleName,
        ...
        try {
            ...
            String expectedMessage="TestCycle restored successfully.";
