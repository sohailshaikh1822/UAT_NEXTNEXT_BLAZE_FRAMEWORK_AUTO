...
public class TC054 extends BaseClass {
    @Test(dataProvider = "tc054", dataProviderClass = TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyingTheToastNotificationMessageAfterUpdatingANewSuiteInTheTestPlanModule(
            String projectName,
            String releaseName,
            String suiteName,
            String UpdatedSuiteName
    )throws InterruptedException
    {
        ...
        try {
            ...
            individualTestSuitePage.enterTestSuiteName(UpdatedSuiteName);
            logger.info("Updated the suite name");
            WaitUtils.waitFor1000Milliseconds();
            individualTestSuitePage.clickSaveButton();
            logger.info("2nd time clicked on save button");
