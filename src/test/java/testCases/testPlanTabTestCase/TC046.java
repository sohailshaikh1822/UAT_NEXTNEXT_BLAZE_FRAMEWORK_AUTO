...
public class TC046 extends BaseClass {
    ...
    @Test(dataProvider = "tc046", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)

    public void verify_Recycle_Bin_count_updates_after_restoring_a_TestCycle(String projectName, String releaseName) throws InterruptedException {
        logger.info("****** Starting TC046 *****************");
