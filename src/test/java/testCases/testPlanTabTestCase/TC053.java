...
public class TC053 extends BaseClass {
    @Test(dataProvider = "tc053", dataProviderClass = TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyingTheToastNotificationMessageAfterUpdatingANewCycleInTheTestPlanModule(
            String projectName,
            String releaseName,
            String testCycleName,
            String updatedTestCycleName
    )throws InterruptedException
    {
        ...
        try {
            ...
            WaitUtils.waitFor1000Milliseconds();
            individualTestCyclePage.setTestCycleName(updatedTestCycleName);
            logger.info("Updated the test cycle name");

            individualTestCyclePage.clickSave();
            logger.info("2nd time clicked on the save button");
