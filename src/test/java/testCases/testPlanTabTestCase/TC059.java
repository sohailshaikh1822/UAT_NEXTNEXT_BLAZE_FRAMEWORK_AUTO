...
public class TC059 extends BaseClass {
    @Test(dataProvider = "tc059", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyDeletedTestCycleNotificationIsNotClickable(
            String projectName,
            String releaseName,
            String cycleName
