...
public class TC100 extends BaseClass {
    @Test(dataProvider = "tc100", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyTestSuiteHistorytabDisplaysVersionDetails(
        ...
        try {
            ...
            WaitUtils.waitFor1000Milliseconds();
            individualTestSuitePage.verifyVersionNumbersAreDisplayedCorrectly();
            logger.info("history table displayed columns");

            WaitUtils.waitFor1000Milliseconds();
            individualTestSuitePage.expandLatestVersion();
            WaitUtils.waitFor1000Milliseconds();
            individualTestSuitePage.verifyNoChangesMessageInExpandedVersion();
