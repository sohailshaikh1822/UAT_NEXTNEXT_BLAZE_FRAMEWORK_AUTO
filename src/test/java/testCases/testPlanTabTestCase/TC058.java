...
public class TC058 extends BaseClass {
    @Test(dataProvider = "tc058", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyDeletedTestSuiteNotificationIsNotClickable(
            String projectName,
            String releaseName,
            String cycleName,
            String suitName
    )throws InterruptedException
    {
        ...
        try {
            ...
            individualTestSuitePage.verifyTestSuiteDeleteNotification(testSuitId);
            logger.info("Test Suit is successfully Deleted");


            WaitUtils.waitFor1000Milliseconds();

            individualTestSuitePage.verifyDeletedTestSuiteNotificationIsNotClickable(testSuitId);
            logger.info("Tootltip has been verified");
