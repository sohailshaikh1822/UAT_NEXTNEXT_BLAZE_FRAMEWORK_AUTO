...
public class TC028 extends BaseClass {
    @Test(dataProvider = "tc028", dataProviderClass = DataProviders.TestPlanDataProvider.class, retryAnalyzer = RetryAnalyzer.class)
    public void VerifyingTheNotificationMessageAfterDeletingACycleInTheTestPlanModule(
            String projectName,
            String releaseName,
            String cycleName
    )throws InterruptedException
    {
        logger.info("****** Starting TC28 **********");
        ...
        try {
            ...
            individualTestCyclePage.verifyTestCycleDeleteNotification(testCycleId);
