...
public class ExcelDataProviders {
    ...
    public static String[][] getExcelDataForDefectTestCase(String sheetName) throws IOException {
        String path = System.getProperty("user.dir") + "/testData/defectTabTestData/defectTestCaseTab_testData.xlsx";
        XLUtility utility = new XLUtility(path);
